...
3. Activate the virtual environment. commit this line:
   .venv\Scripts\activate
   Note: don't forget to set the Python interpreter to venv on the bottom right of your vscode workspace.
4. You must close your PF app first to run the code.
5. On every scripts, these lines of code must be run first:
